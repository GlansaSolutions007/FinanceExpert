...
$routes->group("admin",function($routes){
    ...
    // $routes->get('Home', 'admin::index', ['filter' => 'auth']);
    ...
    // $routes->get('applicationreport', 'admin::applicationreport', ['as' => 'admin.applicationreport']);
...
$routes->group("applicationReportController", function($routes){
    ...
    // $routes->get('exportsToExcels','applicationReportController::exportsToExcels',['as'=>'applicationReportController.exportsToExcels']);
...
$routes->group("staffadmin",function($routes){
    ...
    // $routes->get('agent','staffadmin::agent',['as'=>'staffadmin.agent']);
...
// $routes->post('exportToExcel','agentwisecontroller::exportToExcel',['as'=>'agentwisecontroller.exportToExcel']);
