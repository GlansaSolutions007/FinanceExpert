            ...
            <div class="x_content">
                ...
                <form class="form-label-left input_mask">
                    <div class="field item form-group col-md-10">
                        <label class="col-form-label col-md-3 col-sm-3 label-align">Select Agreement No<span class="required">*</span></label>
                                ...
                                <option value="">Choose..</option>
                                        ...
                                        <?php if ($los){ ?>
                                            <?php foreach ($los as $lo) { ?>
                                                <option value="<?= $lo['AgreementNo'] ?>"><?= $lo['AgreementNo'] ?></option>
                                          <?php
                                          } 
                                         } ?>
                                    </select>
