            ...
            <div class="x_content">
                ...
                <form class="form-label-left input_mask">
                    <div class="field item form-group col-md-10">
                        <label class="col-form-label col-md-3 col-sm-3 label-align">Select Customer Name<span class="required">*</span></label>
                                ...
                                <option value="">Choose..</option>
                                        ...
                                        <?php if ($customer){ ?>
                                            <?php foreach ($customer as $customers) { ?>
                                                <option value="<?= $customers['CustomerName'] ?>"><?= $customers['CustomerName'] ?></option>
                                          <?php
                                          } 
                                         } ?>
                                    </select>
